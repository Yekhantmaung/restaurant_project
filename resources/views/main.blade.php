...
@endif
    ...
    <nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a class="navbar-brand m-auto" href="#">
                ...
                <span class="brand-txt">LuMaw Restaurant</span>
            </a>
            <ul class="navbar-nav">
                <li class="nav-item">
    ...
    <!-- Food Cart -->
    <div style="margin-top: 30px;" class="containter-fluid bg-dark text-light py-5 text-center wow fadeIn">
        @yield('show_cart')
    </div>
    ...
    <div class="container-fluid has-bg-overlay text-center text-light has-height-lg middle-items" id="book-table">
        <div class="">
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="time" id="booktable" name="time" class="form-control form-control-lg custom-form-control" placeholder="EMAIL" required>
                </div>
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
    ...
    <div class="container-fluid bg-dark text-light has-height-md middle-items border-top text-center wow fadeIn">
        <div class="row">
            <div class="col-sm-4">
                <h3>EMAIL US</h3>
                <P class="text-muted">yekhantmaung0@gmail.com</P>
            </div>
            <div class="col-sm-4">
                <h3>CALL US</h3>
                <P class="text-muted">-959761283654</P>
            </div>
            <div class="col-sm-4">
                <h3>FIND US</h3>
                <P class="text-muted">Yangon Myangone 8 Mile Township</P>
            </div>
        </div>
    </div>
    ...
    © 2025 Lumaw Restaurant | Made with ❤️ by YKM
    </footer>
