...
@section('home')
        ...
        @if(session('cart_message'))
           <div style="background-color: lightgreen; color: black !important">{{session('cart_message')}}</div>
        @endif
        <div class="row">
                ...
                <div class="card bg-transparent border my-3 my-md-0">
                    ...
                    <form action="{{route('addtocart')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="quantity" name="quantity" value="1" min="1" style="background-color: rgba(255,255,255,0.1); color: white;">
                        </div>
